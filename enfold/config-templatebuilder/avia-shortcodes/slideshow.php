		...
		static function set_video_slide($video_url, $service = false, $meta = false)
		{
			...
			switch( $service )
			{
				...
				case "youtube":
					...
					$video_url	= explode('v=', trim($video_url));
					...
					'http://www.youtube.com/embed/'.$video_url 
					);
					
					$video_url = apply_filters( 'avf_youtube_video_url' , $video_url);
					
					$video 	= "<div class='av-click-overlay'></div><div class='mejs-mediaelement'><iframe src='{$video_url}' height='1600' width='900'  frameborder='' class='av_youtube_frame' id='{$uid}'></iframe></div>";
